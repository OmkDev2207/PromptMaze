    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          {/* Example Output Box (AI Assistant Response Style) */}
          <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-sm dark:border-zinc-800/80 dark:bg-zinc-900/40 backdrop-blur-md">
            <div className="flex items-center gap-2 border-b border-zinc-100 dark:border-zinc-800 pb-3 select-none">
              <div className="flex h-5 w-5 items-center justify-center rounded-full bg-emerald-600 text-[9px] font-black text-white">
                AI
              </div>
            ...
            <p className="mt-3 text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed font-semibold">
              Here is a preview of the structured output generated by reasoning models (like GPT-4o, Claude 3.5 Sonnet) using this template:
            </p>
            <div className="mt-4 overflow-x-auto rounded-2xl bg-zinc-950 p-5 font-mono text-xs leading-relaxed text-zinc-300 border border-zinc-900 whitespace-pre-wrap select-all shadow-inner">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-3xl border border-indigo-200/60 bg-gradient-to-br from-indigo-50/20 to-violet-50/20 p-6 dark:border-indigo-950/40 dark:from-indigo-950/20 dark:to-violet-950/20 shadow-sm relative overflow-hidden">
