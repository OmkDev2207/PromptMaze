        ...
        <div className="flex flex-col gap-6">
          ...
          {firstPrompt && (
            <div className="rounded-3xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900/40">
              ...
              <div className="mt-3 overflow-x-auto rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
              ...
              {emailCategories
                ...
                .map((c) => (
                  <Link
                    key={c.slug}
                    href={`/emails/${c.slug}`}
                    className="flex items-center justify-between text-xs font-semibold text-zinc-600 hover:text-indigo-600 dark:text-zinc-400 dark:hover:text-indigo-400 transition-colors"
                  >
